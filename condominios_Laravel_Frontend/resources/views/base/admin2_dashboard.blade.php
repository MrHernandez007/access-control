    ...
    <div id="perfil" class="bg-sky-50 border border-sky-200 p-6 rounded-xl shadow-md mt-6 hidden">
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-white border border-gray-200 rounded-lg shadow p-4">
                <h4 class="text-sky-700 font-semibold mb-2">Ver residentes</h4>
                <p class="text-gray-600 text-sm">Visualiza residentes del sistema.</p>
                <a href="/admin2/residentes2" class="text-sky-600 hover:underline text-sm font-medium mt-2 inline-block">Ir a residentes →</a>
            </div>
            <div class="bg-white border border-gray-200 rounded-lg shadow p-4">
                <h4 class="text-sky-700 font-semibold mb-2">Ver visitantes</h4>
                <p class="text-gray-600 text-sm">Visualiza visitantes del sistema.</p>
                <a href="/admin2/visitantes2" class="text-sky-600 hover:underline text-sm font-medium mt-2 inline-block">Ver visitantes →</a>
            </div>
                        <div class="bg-white border border-gray-200 rounded-lg shadow p-4">
                <h4 class="text-sky-700 font-semibold mb-2">Ver visitas</h4>
                <p class="text-gray-600 text-sm">Visualiza visitas del sistema.</p>
                <a href="/admin2/visitas2" class="text-sky-600 hover:underline text-sm font-medium mt-2 inline-block">Ver visitantes →</a>
            </div>
        </div>
    </div>
</div>
